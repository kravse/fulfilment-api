...
const restock = [{ "product_id": 0, "quantity": 3 },
...
const sampleInventory = [{ "mass_g": 700, "product_name": "RBC A+ Adult", "product_id": 0 },
...
const order = { "order_id": 123, "requested": [{ "product_id": 0, "quantity": 5 },
